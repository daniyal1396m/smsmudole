...
* $soapclient = new soapclient_nu( string path [ ,mixed wsdl] );
*
...
class soapclient_nu extends nusoap_base  {
	...
	* @access   public
	*/
	function soapclient_nu($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 180, $portName = ''){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class nusoap_proxy_'.$r.' extends soapclient_nu {
	'.$evalStr.'
}';
		return $evalStr;
	}
...
if (!extension_loaded('soap')) {
	 ...
	 */
	class soapclient extends soapclient_nu {
	}
}
?>
